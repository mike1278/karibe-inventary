...
class ChartWrapper extends React.Component<Props> {
  chartDiv: React.RefObject<any>
  legendDiv: React.RefObject<HTMLDivElement>
  chart: any
  series: any[]
  legends: any[]
  ...
  addSeries = (serie, type) => {
    ...
    series.setData(data);
    series.applyOptions({
      topColor: 'rgba(145, 115, 48, 0.56)',
			bottomColor: 'rgba(145, 115, 48, 0.04)',
			lineColor: 'rgba(145, 115, 48, 1)',
    })
