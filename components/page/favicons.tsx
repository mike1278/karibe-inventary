...
const Favicons = () => {
  ...
  <Head>
    ...
    <meta name="theme-color" content={layout.themes[theme].background.primary} />
    ...
    <meta name="apple-mobile-web-app-title" content={layout.brandName} />
    ...
    <meta name="msapplication-TileColor" content={layout.themes[theme].background.primary} />
